      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.statsGrid}>
            ...
            <View style={[styles.statCard, darkMode && styles.cardDark]}>
                ...
                <Text style={[styles.statValue, darkMode && styles.textDark]}>00</Text>
            </View>

            <View style={[styles.statCard, darkMode && styles.cardDark]}>
                <Feather name="target" size={24} color="#4A5565" style={[styles.statIcon, darkMode && styles.iconDark]} />
                <Text style={[styles.statLabel, darkMode && styles.textDarkGray]}>Projetos Concluídos</Text>
                <Text style={[styles.statValue, darkMode && styles.textDark]}>0</Text>
            </View>

            <View style={[styles.statCard, darkMode && styles.cardDark]}>
                <Feather name="trending-up" size={24} color="#4A5565" style={[styles.statIcon, darkMode && styles.iconDark]} />
                <Text style={[styles.statLabel, darkMode && styles.textDarkGray]}>Dias Consecutivos</Text>
                <Text style={[styles.statValue, darkMode && styles.textDark]}>0</Text>
            </View>
            ...
            <View style={[styles.statCard, darkMode && styles.cardDark]}>
                ...
                <Text style={[styles.statValue, darkMode && styles.textDark]}>0h</Text>
            </View>
